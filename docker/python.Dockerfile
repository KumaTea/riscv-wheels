...
RUN set -ex \
        ...
        && cd Python-$CP312VER \
        && ./configure --prefix=/opt/python/cp312 --enable-shared --enable-optimizations --with-ensurepip=upgrade \
        && make -j16 \
        && make altinstall \
        && cd /tmp \
...
RUN set -ex \
        ...
        && cd Python-$CP311VER \
        && ./configure --prefix=/opt/python/cp311 --enable-shared --enable-optimizations --with-ensurepip=upgrade \
        && make -j16 \
        && make altinstall \
        && cd /tmp \
...
RUN set -ex \
        ...
        && cd Python-$CP310VER \
        && ./configure --prefix=/opt/python/cp310 --enable-shared --enable-optimizations --with-ensurepip=upgrade \
        && make -j16 \
        && make altinstall \
        && cd /tmp \
...
RUN set -ex \
        ...
        && cd Python-$CP39VER \
        && ./configure --prefix=/opt/python/cp39 --enable-shared --enable-optimizations --with-ensurepip=upgrade \
        && make -j16 \
        && make altinstall \
        && cd /tmp \
...
RUN set -ex \
        ...
        && cd Python-$CP38VER \
        && ./configure --prefix=/opt/python/cp38 --enable-shared --enable-optimizations --with-ensurepip=upgrade \
        && make -j16 \
        && make altinstall \
        && cd /tmp \
